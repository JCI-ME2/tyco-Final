...
const navItems = [
  { label: "Main Software", href: "/american-dynamics/main-software" },
  { label: "SSA", href: "/american-dynamics/ssa" },
  { label: "Recorders", href: "/american-dynamics/recorders" },
  { label: "Hardware Add-ons", href: "/american-dynamics/hardware-addons" },
];

export function AmericanDynamicsHeader() {
