...
const navItems = [
  ...
  { label: "Software Modules", href: "/cem-systems/software-modules" },
  { label: "Controllers", href: "/cem-systems/controllers" },
  { label: "Card Readers", href: "/cem-systems/card-readers" },
  { label: "Biometrics", href: "/cem-systems/biometrics" },
  { label: "Locks", href: "/cem-systems/locks" },
];

export function CemSystemsHeader() {
        ...
        <nav className="ml-4 hidden items-center gap-1 lg:flex overflow-x-auto">
          {navItems.map((n, index) => (
            ...
            <Link
              key={n.label}
              href={n.href}
              className={`whitespace-nowrap px-4 py-2 text-[15px] font-normal text-[#333740] transition-colors hover:text-jci-blue ${
